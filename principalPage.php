...
<html lang="en">
  <head>
    ...
    ></script>
    <link rel="stylesheet" href="styles/stylePrincipalPage.css" />
  ...
  <body class="background">
      ...
      <ul class="sideBar__list">
        <li>
          <i class="fa fa-home fa-lg" aria-hidden="true"
            ><a href="sign-in.php" class="simple-text">Home</a></i
          >
        </li>
        <li>
          <i class="fa fa-book fa-lg" aria-hidden="true"
            ><a href="sign-in.php" class="simple-text">My books</a></i
          >
        </li>
        <li>
          <i class="fa fa-users fa-lg" aria-hidden="true"
            ><a href="sign-in.php" class="simple-text">Community</a></i
          >
        </li>
        <li>
          <i class="fa fa-pie-chart fa-lg" aria-hidden="true"
            ><a href="sign-in.php" class="simple-text">News</a></i
          >
        </li>
      </ul>
    </div>
    ...
    <div class="wrapper">
      <div class="wrapper__header">
        ...
        <div>
          <div class="button"><a href="sign-in.php">Sign in</a></div>
          <div class="button">
      ...
      <div class="wrapper__containers">
        ...
        <div class="wrapper__containers__elem">
          ...
          <strong
            >Join our community and let's explore the wonderful world of books
            together!</strong
          >
        </div>
      </div>
